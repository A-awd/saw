...
- preserve useful repository history;
- keep the current branch limited to public-safe documentation;
- do not centralize private operational memory;
- do not merge until the visibility boundary is separately resolved.

See the [repository entry point](../README.md) and [current state](../STATE.md).
